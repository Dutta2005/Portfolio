  ...
  const projects = [
    {
      title: "Jeevan Verse",
      description:
        "A MERN stack web app where users get personalized AI health insights, request blood, join discussions, and support health campaigns—all in one place.",
      techStack: [
        "MERN",
        "RAG",
        "Gemini",
      ...
      imageUrl:
        "https://images.pexels.com/photos/32957343/pexels-photo-32957343.jpeg",
    ...
    },
    {
      title: "Orbit CLI",
      description:
        "A powerful AI CLI tool integrating multiple providers (Gemini, OpenAI, Anthropic) with secure authentication and personalized configs—bringing fast, always-on AI productivity directly to your terminal.",
      techStack: [
        "Next.js",
        "Express.js",
        "AI SDK",
      ...
      imageUrl:
        "https://images.pexels.com/photos/36794058/pexels-photo-36794058.jpeg",
    ...
    },
    {
      title: "PortfolioAI",
      description:
        "A full-stack web application that automatically generates professional portfolios from uploaded resumes using AI-powered parsing and profession-specific templates.",
      techStack: [
        "Next.js",
        "Shadcn UI",
        "NextAuth",
      ...
      imageUrl:
        "https://images.pexels.com/photos/34742373/pexels-photo-34742373.jpeg",
    ...
    },
    {
      title: "Stremify",
      description:
        "A MERN stack web app enabling real-time chat, video calls, and cultural exchange with native speakers worldwide—built for seamless global communication.",
      techStack: ["MERN", "Tailwind CSS", "Tanstack-react-query", "Stream"],
      imageUrl:
        "https://images.pexels.com/photos/32957313/pexels-photo-32957313.jpeg",
    ...
    },
    {
      title: "ReadmeEasy",
      description:
        "A web application using Nextjs and OPENAI API that generate comprehensive README.md files in seconds",
      techStack: ["Next.js", "Shadcn UI", "OpenAI API"],
      imageUrl:
        "https://images.pexels.com/photos/33381355/pexels-photo-33381355.jpeg",
    ...
    },
    {
      title: "Droply",
      description:
        "A Next.js app which a simple and secure cloud app to store, view, and manage your image files",
      techStack: [
        "Next.js",
        "Clerk",
        "HeroUI",
      ...
      imageUrl:
        "https://images.pexels.com/photos/32957326/pexels-photo-32957326.jpeg",
    ...
    },
    {
      title: "PixelFlow",
      description:
        "A Next.js app to compress videos losslessly and resize images for social media, using Clerk, Cloudinary, Prisma, and NeonDB.",
      techStack: [
        "Next.js",
        "Clerk",
        "DaisyUI",
      ...
      imageUrl:
        "https://images.pexels.com/photos/32957365/pexels-photo-32957365.jpeg",
    ...
    <div className="py-16 min-h-screen bg-gray-900">
      <div className="container mx-auto px-6 text-gray-300 md:px-12 xl:px-6">
        <div className="text-center">
          ...
          >
            From AI-powered platforms to developer tools & SaaS products — a
            showcase of what I've built, shipped, and scaled.
          </motion.p>
        </div>
